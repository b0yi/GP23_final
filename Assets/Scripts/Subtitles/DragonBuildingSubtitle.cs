...
public class DragonBuildingSubtitle : Subtitle
{
    ...
    {
        if (!talkManager.dragonBuildingBool) {
            talkManager.dragonBuildingBool = true;
            if (!canvas.isLockingSubtitle) {
                StartCoroutine(ShowSubtitle(talkManager.dragonBuildingSubtitle));
            }
        }
    }
