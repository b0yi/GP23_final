...
public class UIMainMenuFade : MonoBehaviour
{
    ...
    public IEnumerator FadeCanvas(CanvasGroup canvasGroup, Direction direction, float duration)
    {
        ...
        // set the canvas to the start alpha �V this ensures that the canvas is ��reset�� if you fade it multiple times
        ...
        // force the alpha to the end alpha before finishing �V this is here to mitigate any rounding errors, e.g. leaving the alpha at 0.01 instead of 0
